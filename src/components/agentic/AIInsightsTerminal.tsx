      ...
      <div className={`font-mono ${className}`}>
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2 border border-amber-500/40 bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 hover:text-amber-300 text-xs transition-colors"
          >
          ...
          <button
            ...
            className="px-2 py-2 border border-cyan-500/20 text-cyan-400/60 hover:text-cyan-400 text-[10px] transition-colors"
          >
