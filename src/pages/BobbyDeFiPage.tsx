...
export default function BobbyDeFiPage() {
  ...
  return (
    <KineticShell activeTab="terminal">
      <Helmet><title>DeFi Invest | Bobby Agent Trader</title></Helmet>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-5xl mx-auto px-4 py-6 space-y-5">
          ...
          <div>
            ...
            <p className="font-mono text-[11px] text-white/35 leading-relaxed">
              Discover and invest in DeFi products across 20+ chains. Aave, Lido, Compound, PancakeSwap, Kamino, NAVI and more.
              Bobby analyzes yields and recommends the best risk-adjusted opportunities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-4 gap-2">
            {[
              { icon: Globe, label: 'CHAINS', value: '20+', sub: 'Supported' },
              { icon: Layers, label: 'PROTOCOLS', value: '50+', sub: 'Integrated' },
              { icon: DollarSign, label: 'TVL TRACKED', value: '$35B+', sub: 'Across all' },
              { icon: Shield, label: 'ACTIONS', value: '4', sub: 'Deposit/Withdraw/Claim/Search' },
            ].map(s => (
          ...
          <div className="bg-white/[0.02] border border-white/[0.04] rounded-xl overflow-hidden" style={{ backdropFilter: 'blur(12px)' }}>
            ...
            {filtered.length === 0 && (
              <div className="px-4 py-8 text-center font-mono text-[10px] text-white/20">No products found</div>
            )}
          </div>
          ...
          <div className="bg-white/[0.02] border border-white/[0.04] rounded-xl p-5" style={{ backdropFilter: 'blur(12px)' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
              {[
                ...
                { step: '02', title: 'ANALYZE', desc: 'Bobby evaluates risk, TVL, APY history, and smart contract safety', icon: Shield },
                { step: '03', title: 'INVEST', desc: 'One-click deposit. Bobby handles approvals and multi-step orchestration', icon: Zap },
          ...
          <div className="bg-green-500/5 border border-green-500/20 rounded-xl p-5 text-center">
            <div className="font-mono text-[10px] text-white/40 mb-2">Ask Bobby to find the best yields for you</div>
            <a href="/agentic-world/bobby" className="inline-flex items-center gap-2 px-6 py-2.5 bg-green-500 text-black font-mono text-[11px] font-bold tracking-wider rounded hover:bg-green-400 transition-all">
