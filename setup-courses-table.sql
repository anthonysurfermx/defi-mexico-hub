-- SQL para crear la tabla de cursos de DeFi Academy
...
CREATE TABLE IF NOT EXISTS courses (
  ...
  duration VARCHAR(50) NOT NULL, -- Ej: "3h 45m"
  ...
  topics TEXT[] DEFAULT '{}', -- Array de strings para los temas
  circle_url VARCHAR(500) NOT NULL, -- URL del curso en Circle
  thumbnail_url VARCHAR(500), -- URL de imagen del curso (opcional)
...
COMMENT ON TABLE courses IS 'Tabla para almacenar cursos de DeFi Academy';
COMMENT ON COLUMN courses.topics IS 'Array de temas/tags del curso';
COMMENT ON COLUMN courses.circle_url IS 'URL del curso en Circle.so donde se imparte';
COMMENT ON COLUMN courses.featured IS 'Indica si el curso está destacado en la homepage';